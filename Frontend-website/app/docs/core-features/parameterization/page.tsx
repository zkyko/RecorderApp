...
export default function ParameterizationPage() {
    ...
    <div className="min-h-screen bg-zinc-950">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="space-y-8">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-4 bg-violet-500/10 border border-violet-500/30 rounded-lg">
                ...
                <ul className="text-sm text-zinc-400 space-y-1 list-disc list-inside">
                  ...
                  <li>Creates a Map for code replacement</li>
                </ul>
              </div>
              ...
              <div className="p-4 bg-zinc-800/50 rounded-lg border border-zinc-700">
                ...
                <ul className="text-sm text-zinc-400 space-y-1 list-disc list-inside">
                  ...
                  <li>Data is saved to tests/d365/data/TestNameData.json</li>
          ...
          <Card className="bg-zinc-900/50 border-zinc-800">
            <CardHeader>
              <CardTitle className="text-2xl">Code Replacement and Data Structure</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="p-4 bg-zinc-800/50 rounded-lg border border-zinc-700">
  ...
  for (const row of data) {
    ...
    // ... rest of test steps
          ...
          <Card className="bg-zinc-900/50 border-zinc-800">
            <CardHeader>
              <CardTitle className="text-2xl">Regeneration and Updates</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <p className="text-zinc-300">
              ...
              <div className="p-4 bg-zinc-800/50 rounded-lg border border-zinc-700">
                ...
                <p className="text-sm text-zinc-400">
                  Data files are stored at: <code className="text-blue-400 bg-zinc-900/50 px-1 rounded">workspacePath/tests/d365/data/TestNameData.json</code>
                </p>
