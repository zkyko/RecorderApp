      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-12">
          ...
          <p className="text-slate-400 text-lg max-w-3xl">
            Comprehensive guide to the FourHands Automation Suite codebase. Learn about each module, file, and component 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          <Link href="/docs/developer/architecture" className="group">
            <div className="bg-slate-900/50 border border-slate-800/50 rounded-lg p-6 hover:border-blue-500/50 hover:bg-slate-900/70 transition-all shadow-lg hover:shadow-blue-500/10">
          ...
          <Link href="/docs/developer/generators" className="group">
            <div className="bg-slate-900/50 border border-slate-800/50 rounded-lg p-6 hover:border-blue-500/50 hover:bg-slate-900/70 transition-all shadow-lg hover:shadow-blue-500/10">
              <FileCode className="h-8 w-8 text-blue-400 mb-3" />
              <h3 className="text-xl font-semibold mb-2 text-slate-100 group-hover:text-blue-400 transition-colors">
                Code Generators
              </h3>
              <p className="text-slate-400 text-sm">
        ...
        <div className="bg-slate-900/50 border border-slate-800/50 rounded-lg p-6 mb-8 shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-slate-100">Quick Start for New Developers</h2>
          <div className="space-y-4 text-slate-300">
            <div>
              <h3 className="font-semibold text-blue-400 mb-2">1. Understand the Architecture</h3>
              <p className="text-sm text-slate-400">
                Start with the <Link href="/docs/developer/architecture" className="text-blue-400 hover:text-blue-300 hover:underline transition-colors">Architecture Overview</Link> to understand 
                how the application is structured into four main branches: Core Runtime, Main Process, Code Generation, and Studio UI.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-blue-400 mb-2">2. Explore Core Modules</h3>
              <p className="text-sm text-slate-400">
                The <Link href="/docs/developer/core" className="text-blue-400 hover:text-blue-300 hover:underline transition-colors">Core Modules</Link> run inside the browser 
                context and handle recording, locator extraction, and page classification. This is where the magic happens.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-blue-400 mb-2">3. Learn the Main Process</h3>
              <p className="text-sm text-slate-400">
                The <Link href="/docs/developer/main-process" className="text-blue-400 hover:text-blue-300 hover:underline transition-colors">Main Process</Link> orchestrates 
                everything, manages IPC communication, and provides services for recording, testing, and integrations.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-blue-400 mb-2">4. Study Code Generation</h3>
              <p className="text-sm text-slate-400">
                <Link href="/docs/developer/generators" className="text-blue-400 hover:text-blue-300 hover:underline transition-colors">Code Generators</Link> transform 
        ...
        <div className="bg-blue-600/10 border border-blue-500/30 rounded-lg p-6 shadow-lg">
