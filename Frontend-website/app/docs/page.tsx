...
import { ArrowLeft, BookOpen, Settings, Code, Sparkles, Zap } from "lucide-react";
...
const docCategories = [
  ...
  {
    title: "Core Features",
    description: "Deep dive into Studio Recorder, Parameterization, Test Execution, Locator System",
    icon: Zap,
