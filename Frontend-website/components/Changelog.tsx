...
const changelog: ChangelogEntry[] = [
  ...
  },
  {
    ...
    items: [
      ...
      "Diagnostics / Self Test Screen - Run environment, workspace, and integration health checks directly inside FourHands Automation Suite",
  ...
  },
  {
    ...
    items: [
      "BrowserStack Test Management - Embedded BrowserStack TM interface directly in FourHands Automation Suite sidebar with persistent login sessions",
  ...
  },
  {
    ...
    date: "December 2025",
    type: "feature",
    title: "Web Demo Mode - Try FourHands Automation Suite in Your Browser",
    description: "Experience FourHands Automation Suite's full interface directly in your browser with our new interactive web demo. No installation required - explore all features, see realistic mock data, and get a feel for the platform before downloading.",
    items: [
      "Interactive Web Demo - Full FourHands Automation Suite UI accessible at /demo with no installation required",
